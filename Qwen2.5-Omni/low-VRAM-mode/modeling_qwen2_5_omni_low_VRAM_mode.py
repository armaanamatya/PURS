    ...
    def generate(
        ...
        **kwargs,
        ...
        if hasattr(self, 'talker') and self.talker is not None:
            self.talker.to("cpu")
        if hasattr(self, 'token2wav') and self.token2wav is not None:
            self.token2wav.to("cpu")
        torch.cuda.empty_cache()
        self.thinker.to("cuda")
        
        if speaker not in self.speaker_map and return_audio:
        ...
        speaker_params = self.speaker_map.get(speaker, None)
        if generate_audio:
