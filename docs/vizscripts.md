...
> Technical documentation for the four custom scripts in `PURS/` that instrument
> the Qwen2.5-Omni + OmniZip pipeline.

> **For end-to-end pipeline architecture and OmniZip algorithm internals, see
> [`omnizip_deep_dive.md`](omnizip_deep_dive.md).**

---

## Table of Contents

1. [viz_attention_qwen.py — Baseline Attention Probe](#3-viz_attention_qwenpy)
2. [viz_attention_omnizip.py — Compressed Attention Probe](#4-viz_attention_omnizippy)
3. [eval_qwen_omni.py — Baseline Evaluation Harness](#5-eval_qwen_omnipy)
4. [eval_qwen_omni_zip.py — OmniZip Evaluation Harness](#6-eval_qwen_omni_zippy)
5. [Cross-Script Comparison Matrix](#7-cross-script-comparison-matrix)
6. [Shared Assumptions, Gotchas & Subtle Bugs](#8-shared-assumptions-gotchas--subtle-bugs)
7. [Data Flow Diagrams](#9-data-flow-diagrams)
