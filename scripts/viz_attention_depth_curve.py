...
Produces:
  ...
  4. Modality attention share heatmap (layers x modalities)

Run from: /data/armaan/purs/
  python viz_attention_depth_curve.py
"""
...
OUT_DIR    = os.path.join(os.path.dirname(os.path.dirname(os.path.abspath(__file__))), "vizzing", "depth_curve")
